...
class SettingsActivity : AppCompatActivity(),
  ...
  override fun onPreferenceStartFragment(
    ...
    val fragment = supportFragmentManager.fragmentFactory.instantiate(
      ...
      arguments = args
      // deprecated, so use setFragmentResultListener instead, if you want to handle result values
  ...
  // Hint: ignore the Menu/Analyse/InspectCode Warnings:
  //			Class "SyncFragment" is never used
  //			Class "MessageFragment" is never used
  //  Those two fragments MUST be provided to make settings work
